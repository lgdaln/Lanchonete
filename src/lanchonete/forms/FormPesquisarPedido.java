 ...
 * @author User
 */
public class FormPesquisarPedido extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPesquisarPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
